...
const configs: Record<LegalEntity, EntityConfig> = {
  blaster: {
    ...
    amo: {
      ...
      // Победы (числитель Винрейта/Конверсии) — Продажа + Реализовано
      winStatusIds: [84825134, 142],
      // Завершённые (знаменатель Винрейта) — Продажа + Реализовано + Закрыто и не реализовано
  ...
  cult: {
    ...
    amo: {
      ...
      // Запросы — лиды в 8 статусах (от КП до терминальных), месяц = «Бриф получен»:
      requestStatusIds: [85003162, 85003166, 85003170, 85003174, 85003178, 85003182, 142, 143],
      briefDateFieldId: 1647617,
    ...
    budgets: {
      ...
      // С 2026-01 весь год из «03 Бюджет 2026» (раньше янв–апр брался из «0 Бюджет 2026»).
      cutoffMonth: "2026-01",
    },
